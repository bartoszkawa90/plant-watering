...
"                <a style=\"color: black;\" class=\"nav-item nav-link\" href=\"{% url 'homepage' %}\"><font size=\"6\">Homepage</font></a>"
"                <a style=\"color: black;\" class=\"nav-item nav-link\" href=\"{% url 'documentation' %}\"><font size=\"6\">Documentation</font></a>"
"              </div>"
"              <!-- Navbar Right Side -->"
